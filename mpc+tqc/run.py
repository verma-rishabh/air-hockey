...
def get_args():
    ...
    arg_test.add_argument("--example", type=str, choices=["tqc_ik", "tqc_mpc", "tqc_14", "sac"], default="")
...
if __name__ == "__main__":
    ...
    # Load Agent
    if filtered_args["example"] == "tqc_ik":
        from air_hockey_agent.agent_builder_tqc_ik import build_agent

    elif filtered_args["example"] == "tqc_mpc":
        from air_hockey_agent.agent_builder_tqc_mpc import build_agent
    
    elif filtered_args["example"] == "tqc_14":
        from air_hockey_agent.agent_builder_tqc_14 import build_agent
